...
State.Token.TABLE = State.Token.APP + '.table';
State.Token.CHART = State.Token.APP + '.chart';
...
(function() {
	...
	[
		...
		_createItem(_parent, 'STATE.TABLE', State.Token.TABLE, null, ['count', 'page', 'filters', 'orders']),
		_createItem(_parent, 'STATE.CHART', State.Token.CHART, null, ['count', 'page', 'filters', 'orders']),
